namespace AGS.Editor
{
    partial class PreferencesEditor
    {
        ...
        private void InitializeComponent()
        {
			...
			this.btnApplyColorTheme = new System.Windows.Forms.Button();
    ...
    ".";
			...
			// groupBox3
			// 
			this.groupBox3.Controls.Add(this.btnApplyColorTheme);
			...
			// btnApplyColorTheme
			// 
			this.btnApplyColorTheme.Location = new System.Drawing.Point(15, 102);
			this.btnApplyColorTheme.Name = "btnApplyColorTheme";
			this.btnApplyColorTheme.Size = new System.Drawing.Size(131, 23);
			this.btnApplyColorTheme.TabIndex = 12;
			this.btnApplyColorTheme.Text = "Apply Color Theme";
			this.btnApplyColorTheme.UseVisualStyleBackColor = true;
			this.btnApplyColorTheme.Click += new System.EventHandler(this.btnApplyColorTheme_Click);
			// 
			// btnImportColorTheme
			// 
			...
			this.groupBox4.Location = new System.Drawing.Point(378, 346);
    ...
    "games only)";
        ...
        private System.Windows.Forms.Button btnApplyColorTheme;
    }
}
